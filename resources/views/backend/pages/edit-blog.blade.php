                        ...
                        <div class="card-body">
                            ...
                            {{-- <div class="d-flex align-items-center justify-content-between">
                             ...
                             <!--  Modal content for the above example -->
                                    ...
                                    <form action="{{route('blog.update', ['blog' => $blog->id])}}" method="POST" class="modal-body" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="dropify" id="thumbnail" name="thumbnail" data-default-file="{{ asset('uploads/' . $blog->thumbnail) }}"/>
                                        </div>
                                        <div class="form-group">
                                            <label>Body</label>
                                            {{-- <textarea id="summernote" name="body" required>{!!$blog->body!!}</textarea> --}}
                                            <textarea id="editor" name="body" required>{!!$blog->body!!}</textarea>
                                        </div>
